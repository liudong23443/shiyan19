            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        plt.title("特征重要性排序", fontsize=14, fontname='SimHei')
                        plt.tight_layout()
                    ...
                    # 回退到最基本的特征重要性显示
                    try:
                        st.warning("无法生成SHAP解释图，显示基本特征重要性...")
                        ...
                        if hasattr(model, 'feature_importances_'):
                            ...
                            # 添加标题和标签
                            ax.set_title('特征重要性', fontsize=14, fontname='SimHei')
                            ...
                            st.warning("模型没有提供特征重要性信息")
                    except Exception as fallback_error:
                        st.error("无法显示任何解释图表，请联系技术支持")
